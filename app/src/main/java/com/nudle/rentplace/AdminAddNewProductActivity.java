...
{
    private String CategoryName, Description, Price, Pname, Ptime, saveCurrentDate, saveCurrentTime;
    private Button AddNewProductButton;
    private ImageView InputProductImage;
    private EditText InputProductName, InputProductTime, InputProductDescription, InputProductPrice;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Toasty.info(this, "Describe your product", Toast.LENGTH_SHORT).show();
        ...
        InputProductTime = (EditText) findViewById(R.id.product_time);
    ...
    private void StoreProductInformation()
    {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            {
                Toasty.success(AdminAddNewProductActivity.this, "Product Image uploaded Successfully...", Toast.LENGTH_SHORT).show();
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            Toasty.success(AdminAddNewProductActivity.this, "got the Product image Url Successfully...", Toast.LENGTH_SHORT).show();
